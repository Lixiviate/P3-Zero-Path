  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-16">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-800 mb-6 text-center">Your Sustainability Goals</h1>
        
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">Current Carbon Footprint</h2>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Your Goals</h2>
          {goals.length > 0 ? (
            ...
            <p className="text-gray-500 italic">No goals set yet. Add your first goal below!</p>
          )}
        </div>
