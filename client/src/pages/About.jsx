...
const About = () => {
  return (
    <div className="bg-blue-400 bg-opacity-40 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-xl max-w-2xl w-full text-white">
      ...
      <p className="text-lg mb-4">
        ...
        your companion on the journey toward a greener future.
      </p>
